...
namespace Engine
{
    void CameraBase::SetOrthographicProjection(float fLeft, float fRight, float fTop, float fBottom, float fNear, float fFar)
    {
    ...
    void CameraBase::SetPerspectiveProjection(float fovy, float aspect, float fNear, float fFar)
    {
    ...
    void CameraBase::SetViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up)
    {
    ...
    void CameraBase::SetViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up)
    {
        SetViewDirection(position, target - position, up);
    }

    void CameraBase::SetViewYXZ(glm::vec3 position, glm::vec3 rotation)
    {
