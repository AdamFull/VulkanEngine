...
RendererFinal::RendererFinal(std::shared_ptr<Device> device, std::shared_ptr<SwapChain> swapchain)
{
    m_device = device;
    m_swapchain = swapchain;
}

void RendererFinal::Create()
{
    vAttachments = 
    {
        {
...
void RendererFinal::ReCreate()
{
    RendererBase::ReCreate();
}

void RendererFinal::Update(vk::CommandBuffer& commandBuffer, void* ubo)
{
    RendererBase::Update(commandBuffer, ubo);
}

void RendererFinal::Cleanup()
{
    RendererBase::Cleanup();
}


void RendererFinal::CreateRenderPass()
{
...
void RendererFinal::CreateFrameBuffers()
{
...
void RendererFinal::CreateUniformBuffers()
{
...
void RendererFinal::CreateMaterial()
{
