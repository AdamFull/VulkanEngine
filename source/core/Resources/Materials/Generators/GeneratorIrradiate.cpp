...
GeneratorIrradiate::GeneratorIrradiate(std::shared_ptr<Core::Device> device, std::shared_ptr<Core::SwapChain> swapchain)
{
    m_device = device;
    m_swapchain = swapchain;
}

void GeneratorIrradiate::Create()
{
    m_iDimension = 64;
    CreateTextures();
...
void GeneratorIrradiate::Generate(uint32_t indexCount, uint32_t firstIndex)
{
