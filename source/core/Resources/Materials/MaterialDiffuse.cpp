...
void MaterialDiffuse::Create(std::shared_ptr<ResourceManager> pResMgr)
{
    ...
    m_mTextures[ETextureAttachmentType::eBRDFLUT] = pResMgr->Get<Texture::TextureBase>("environment_component_brdf")->GetDescriptor();
    m_mTextures[ETextureAttachmentType::eIrradiance] = pResMgr->Get<Texture::TextureBase>("environment_component_irradiate_cube")->GetDescriptor();
    m_mTextures[ETextureAttachmentType::ePrefiltred] = pResMgr->Get<Texture::TextureBase>("environment_component_prefiltred_cube")->GetDescriptor();
