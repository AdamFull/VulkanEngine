...
namespace engine
{
    namespace core
    {
        struct Initializers
        {
            ...
            static vk::PipelineRasterizationStateCreateInfo PipelineRasterizerStateCI(vk::PolygonMode polygonMode, vk::CullModeFlags cullMode, vk::FrontFace frontFace, vk::Bool32 depthClamp, vk::Bool32 bDepthBias = VK_FALSE);
