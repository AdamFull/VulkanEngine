...
void CDeferredStage::create()
{
    ...
    framebuffer_1->addOutputReference(0U, "packed_tex", "emission_tex"); //framebuffer_1->addOutputReference(0U, 1U, 2U, 3U);
    framebuffer_1->addOutputReference(1U, "composition_tex");
    framebuffer_1->addInputReference(1U, "packed_tex", "emission_tex", "depth_tex"); //framebuffer_1->addInputReference(1U, 1U, 2U, 3U, 4U);
    framebuffer_1->addDescription(0U, "depth_tex");
