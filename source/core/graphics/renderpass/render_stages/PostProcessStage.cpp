...
void CPostProcessStage::create()
{
    ...
    if(enable_bloom)
    {
        ...
        framebuffer_0->addOutputReference(0, 0);
        ...
        framebuffer_0->addDescription(0);
        ...
        framebuffer_1->setRenderArea(vk::Offset2D{0, 0}, vk::Extent2D(screenExtent.width/8, screenExtent.height/8));
    ...
    framebuffer_5->addOutputReference(0, 0);
    ...
    framebuffer_5->addDescription(0);
