...
void CShadowMappingStage::create()
{
    ...
    auto shadows_fb = utl::make_scope<CFramebufferNew>();
    ...
    shadows_fb->addRenderer(utl::make_scope<CCascadeShadowPass>());
    ...
    shadows_fb->addRenderer(utl::make_scope<CDirectShadowPass>());
    ...
    shadows_fb->addRenderer(utl::make_scope<COmniShadowPass>());
