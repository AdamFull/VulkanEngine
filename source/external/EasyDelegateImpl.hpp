...
==================================
Copyright (c) 2021 AdamFull && range36rus
1. Definitions
--------------
1.1. "Contributor"
...
namespace EasyDelegate
{
    ...
    public:
        ...
        {
            m_pDelegate = std::function<_Signature>(std::forward<_LabbdaFunction>(lfunc));
        }
        ...
        {
            return m_pDelegate(std::forward<Args>(args)...);
        }
    ...
    private:
        std::function<_Signature> m_pDelegate;
        /**
         * @brief 
         * 
