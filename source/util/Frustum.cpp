...
template<>
std::unique_ptr<CFrustum> utl::singleton<CFrustum>::_instance{nullptr};

void CFrustum::update(const glm::mat4& view, const glm::mat4& projection)
{
...
void CFrustum::normSide(size_t side)
{
